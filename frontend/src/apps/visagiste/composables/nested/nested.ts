...
import { consoleError, getCurrentInstance, getUid, propsFactory } from '@/apps/visagiste/utils'
...
export const BaseNestedSymbol: InjectionKey<NestedProvide> = Symbol.for('visagiste:nested')
...
export const useNestedProps = propsFactory({
  activatable: Boolean,
  selectable: Boolean,
...
export const useNested = (props: NestedProps) => {
  ...
  provide(BaseNestedSymbol, nested)

  return nested.root
}

export const useNestedItem = (id: Ref<unknown>, isGroup: boolean) => {
  const parent = inject(BaseNestedSymbol, emptyNested)
  ...
  isGroup && provide(BaseNestedSymbol, item)
...
export const useNestedGroupActivator = () => {
  ...
  provide(BaseNestedSymbol, { ...parent, isGroupActivator: true })
}