// Composables
import {useFocusProps} from "./focus";
...
import {getCurrentInstance, getCurrentInstanceName, getUid, propsFactory, wrapInArray} from "@/apps/visagiste/utils";
...
export const useValidationProps = propsFactory({
	disabled: {
