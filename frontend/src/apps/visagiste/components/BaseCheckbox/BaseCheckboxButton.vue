<script lang="ts">
// Components
import BaseSelectionControl, { useBaseSelectionControlProps } from '@/apps/visagiste/components/BaseSelectionControl/BaseSelectionControl.vue'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const controlProps = computed(() => omit(BaseSelectionControl.filterProps(props), ['modelValue']))
