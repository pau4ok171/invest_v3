...
import { useLocationProps } from "@/apps/visagiste/composables/location";
...
import { useLocation } from "@/apps/visagiste/composables/location";
import { useRounded } from "@/apps/visagiste/composables/rounded";
import { provideTheme } from "@/apps/visagiste/composables/theme";
import { useRtl } from "@/apps/visagiste/composables";

// Utilities
import { computed } from "vue";
import { clamp, convertToUnit, IN_BROWSER } from "@/apps/visagiste/utils";
...
const props = defineProps(useBaseProgressLinearProps());
const slots = defineSlots<BaseProgressLinearSlots>();
