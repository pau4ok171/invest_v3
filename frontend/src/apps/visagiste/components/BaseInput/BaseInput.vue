...
// Composables
import {useValidation, useValidationProps} from "@/apps/visagiste/composables/validation";
...
import {defineComponent, EventProp, getUid, only, propsFactory} from "@/apps/visagiste/utils";
