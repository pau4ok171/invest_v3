...
import {defineComponent, focusableChildren, IN_BROWSER, propsFactory} from '@/apps/visagiste/utils'
import {
  calculateUpdatedTarget,
  calculateCenteredTarget,
  getOffsetSize,
  getScrollPosition,
  getScrollSize, getClientSize
} from "./helpers";
...
export const BaseSlideGroupSymbol: InjectionKey<GroupProvide> = Symbol.for('visagiste:base-slide-group')
      ...
      watch(() => [group.selected.value, containerRect.value, contentRect.value, isHorizontal.value], () => {
        ...
        frame = requestAnimationFrame(() => {
          if (contentRect.value && contentRect.value) {
            ...
            isOverflowing.value = containerSize.value + 1 < containerSize.value
          }
