...
// Components
import BaseCheckboxButton, {
  useBaseCheckboxButtonProps,
} from './BaseCheckboxButton.vue'
...
export type BaseCheckboxSlots = Omit<BaseInputSlots, 'default'> &
...
<template>
  <BaseInput
    :class="['base-checkbox', $props.class]"
