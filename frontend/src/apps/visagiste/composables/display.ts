...
export const DisplaySymbol: InjectionKey<DisplayInstance> = Symbol.for('visagiste:display')
...
export function useDisplay (
  ...
  if (!display) throw new Error('Could not find Visagiste display injection')
