...
// Utilities
import { computed, Fragment, h, ref, Text, watch } from 'vue'
import {
  animate,
  convertToUnit,
  defineComponent,
...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const labelRef = ref<InstanceType<typeof BaseFieldLabel>>()
    const floatingLabelRef = ref<InstanceType<typeof BaseFieldLabel>>()
