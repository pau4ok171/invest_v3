...
import {consoleWarn, propsFactory} from "@/apps/visagiste/utils";

// Types
import type {ComponentInternalInstance, ComputedRef, InjectionKey, PropType, Raw, Ref} from "vue";
import type {ValidationProps} from "@/apps/visagiste/composables/validation";
...
export const FormKey: InjectionKey<FormProvide> = Symbol.for('visagiste:form')
...
export const useFormProps = propsFactory({
  disabled: Boolean,
  fastFail: Boolean,
  readonly: Boolean,
  modelValue: {
