...
// Composables
import {useDelayProps, useDelay} from '@/apps/visagiste/composables/delay';
...
export const useActivatorProps = propsFactory({
...
export function useActivator (
  ...
  const contentEvents = computed(() => {
    ...
    if (props.closeOnContentClick) {
      const menu = inject(BaseMenuSymbol, null)
      events.onClick = () => {
