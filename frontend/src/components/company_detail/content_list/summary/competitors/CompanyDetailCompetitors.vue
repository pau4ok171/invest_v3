...
import TheCompanyDetailCompetitorsItem
  from "@/components/company_detail/content_list/summary/competitors/TheCompanyDetailCompetitorsItem.vue";
...
<CompanyDetailSection>
  ...
  <DetailSectionTitle>{{ company.ticker }} Competitors</DetailSectionTitle>
